...
/**
 * ClassName: TwoArrayExer3
 * Description:
 *
 * @Author Mabuyao
 * @Create 2023/7/28 17:39
 * @Version 1.0
 */
public class TwoArrayExer3 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < employees.length; i++) {
            ...
            switch (employeeType) {
                case "10" -> System.out.print("普通职员\t");
                case "11" -> System.out.print("程序员\t");
                case "12" -> System.out.print("设计师\t");
                case "13" -> System.out.print("架构师\t");
            }
