...
public class FileTest1 {
    ...
    * public File getAbsoluteFile()：获取绝对路径表示的文件（对象）
    ...
    * */
    ...
    public void test3() {
        //public String[] list()
        File file1 = new File("E:\\BaiduNetdiskDownload\\00尚硅谷Java入门教程，java电子书+Java面试真题（2023新版）\\01_课件与电子教材\\01_课件与电子教材\\01_课件与电子教材");
